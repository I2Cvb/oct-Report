...
Due to the fact that breast cancer remains the leading cause of cancer death among female population world-wide, any attempt to create tools for assisting radiologists during the diagnosis process is necessary.
However, most of the technologies developed in the imaging laboratories are expelled from this process by clinicians particularly because these technologies are not based on the already existing clinical findings and procedures. To address this issue, we argue that the development of \ac{cad} systems that take advantage of the clinical findings already adopted by clinicians, strategies to accurately delineate the breast structures and its lesions are the missing piece of the puzzle. Therefore, a highly modular and flexible framework for segmenting breast tissues and lesions present in \ac{bus} images using optimization strategies and high-level descriptors designed analogously to the visual cues used by radiologists is here proposed.
\end{abstract}
