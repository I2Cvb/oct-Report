...
This information has been replicated in Fig.\,\ref{fig:surveyResults} using \ac{aov}.
...
It is interesting to note that some methodologies outperform the experiment carried out in~\cite{gerard2013}.
