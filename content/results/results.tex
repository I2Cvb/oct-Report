...
Figure~\ref{fig:results} shows  qualitative results, whereas the quantitative results from the best configuration are reported as a table in Fig.\,\ref{fig:surveyResults:survey}. %~\cite{massich2013phd}.
...
Due to the lack of publicly available data and source code there is no manner to perform a methodology comparison further than compiling the results reported in the literature.
State-of-the-art methodologies found in the literature are summarized in Fig.\,\ref{fig:surveyResults} and the results are reported in terms of \ac{aov} for comparison purposes.
...
The iconography used in Fig.\,\ref{fig:surveyResults:survey} relates methodology stages, the technology used and if the stages have been treated separately or as a single processing.
...
Figure~\ref{fig:surveyResults:comparison} arranges the information for direct visual comparison.
...
An extra element is also represented in Fig.\,\ref{fig:surveyResults:comparison} as a blue swatch delimited by two blue dashed lines.
...
Comparing these results, the inconvenience of unexciting public data can be obviously highlighted, since that several of these results outperform the manual delineations performed in Pons et al.~\cite{gerard2013}.
