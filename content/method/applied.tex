...
\begin{table}[b]
  ...
  \end{tabular}
  \tikz[remember picture, overlay, inner sep=0mm, outer sep=0mm]{\node[inner sep=0mm, outer sep=0mm, anchor=south west] at (featCoord) {\includegraphics[height=13pt]{featAll}};}
\end{table}
